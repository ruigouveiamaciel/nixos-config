  ...
  passthru = {
    sources = {
      ...
      "x86_64-linux" = fetchurl {
        url = "https://github.com/sst/opencode/releases/download/v${finalAttrs.version}/opencode-linux-x64-baseline.tar.gz";
        hash = "sha256-XOKkcI78rDlotWCZtRDcyRYl1tPsCSRXjZLHc+RiEXc=";
      };
    };
